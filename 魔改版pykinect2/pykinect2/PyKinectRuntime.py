...
if sys.hexversion >= 0x03000000: 
    ...
    time_func = time.perf_counter if hasattr(time, 'perf_counter') else time.clock
else:
    import thread 
...
class PyKinectRuntime(object):
    ...
    def __init__(self, frame_source_types):
        ...
        if(self.frame_source_types & PyKinectV2.FrameSourceTypes_Body):
            ...
            self._body_frame_data_type = ctypes.POINTER(PyKinectV2.IBody) * self._body_frame_data_capacity.value
            self._body_frame_data = ctypes.cast(self._body_frame_data_type(), ctypes.POINTER(ctypes.POINTER(PyKinectV2.IBody)))
    ...
    def get_last_color_frame(self):
        with self._color_frame_lock:
            if self._color_frame_data is not None:
                ...
                self._last_color_frame_access = time_func()
                return data
            else:
                return None
    ...
    def get_last_infrared_frame(self):
        with self._infrared_frame_lock:
            if self._infrared_frame_data is not None:
                ...
                self._last_infrared_frame_access = time_func()
                return data
            else:
                return None
    ...
    def get_last_depth_frame(self):
        with self._depth_frame_lock:
            if self._depth_frame_data is not None:
                ...
                self._last_depth_frame_access = time_func()
                return data
            else:
                return None
    ...
    def get_last_body_index_frame(self):
        with self._body_index_frame_lock:
            if self._body_index_frame_data is not None:
                ...
                self._last_body_index_frame_access = time_func()
                return data
            else:
                return None
    ...
    def get_last_body_frame(self):
        with self._body_frame_lock:
            if self._body_frame_bodies is not None:
                self._last_body_frame_access = time_func()
        ...
        try:
            ...
            try:
                with self._color_frame_lock:
                    ...
                    self._last_color_frame_time = time_func()
            except: 
                pass
            colorFrame = None
        except:
        ...
        try:
            ...
            try:
                with self._depth_frame_lock:
                    ...
                    self._last_depth_frame_time = time_func()
            except:
                pass
            depthFrame = None
        except:
        ...
        try:
            ...
            try: 
                with self._body_frame_lock:
                    ...
                    self._last_body_frame_time = time_func()
        ...
        try:
            ...
            try:
                with self._body_index_frame_lock:
                    ...
                    self._last_body_index_frame_time = time_func()
            except: 
                pass
            bodyIndexFrame = None
        except:
        ...
        try:
            ...
            try:
                with self._infrared_frame_lock:
                    ...
                    self._last_infrared_frame_time = time_func()
            except:
                pass
            infraredFrame = None
        except:
